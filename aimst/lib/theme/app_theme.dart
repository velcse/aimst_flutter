...
import 'package:flutterapp/theme/theme_type.dart';
...
class AppTheme {
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    /// AppBar Theme
    appBarTheme: AppBarTheme(backgroundColor: const Color(0xff161616)),

    /// Card Theme
    cardTheme: CardTheme(color: const Color(0xff222327)),
    ...
    inputDecorationTheme: InputDecorationTheme(
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: const Color(0xff069DEF)),
      ),
    ...
    /// Divider Color
    dividerTheme:
        DividerThemeData(color: const Color(0xff363636), thickness: 1),
    ...
    /// Bottom AppBar Theme
    bottomAppBarTheme:
        BottomAppBarTheme(color: const Color(0xff464c52), elevation: 2),
    ...
    tabBarTheme: TabBarTheme(
      ...
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: const Color(0xff069DEF), width: 2.0),
      ),
    ),
